...
class SysmanageAgent < Formula
  ...
  url "https://github.com/bceverly/sysmanage-agent/archive/refs/tags/v3.0.1.2.tar.gz"
  sha256 "5f810c31d4b984934dd6205b0dc4df148313ca594c9eb0afe46d3b765019710f"
